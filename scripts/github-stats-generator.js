/**
 * Tech Stack SVG Generator
 * Gera SVG dinâmico com layout otimizado para todas as tecnologias
 */
...
function generateSVG(technologies, theme = "dark") {
  ...
  const techElements = technologies
    ...
    <g class="tech-item" style="animation-delay: ${index * 0.05}s">
      ...
      <!-- Tech icon -->
      <image x="${x - 20}" y="${y - 25}" width="40" height="40" 
             href="${tech.url}" />
...
async function generateTechStackSVGs() {
  console.log("Gerando SVGs da tech stack...")
